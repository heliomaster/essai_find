...
class essaiFindDb():
    ...
    def __init__(self):
        ...
        query.exec_('''CREATE TABLE Pilots_exp(id INTEGER PRIMARY KEY UNIQUE , pilot_1 TEXT,aircraft TEXT, date_time1 TEXT, date_time2 TEXT)''')

        query.exec_(
            '''CREATE TABLE Aircraft(id INTEGER PRIMARY KEY, immatriculation TEXT)''')

        query.exec_('''INSERT INTO Pilots_exp (id ,pilot_1, aircraft, date_time1 , date_time2 )  VALUES 
        ( 1,'NOM','F-FFFF','2030/01/01','2030/01/01')''')
